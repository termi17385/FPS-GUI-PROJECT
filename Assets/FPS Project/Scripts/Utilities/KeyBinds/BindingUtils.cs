...
namespace FPSProject.Keybinds
{
    ...
    {
        /// <summary>
        /// used to convert keycodes to standard names
        /// </summary>
        ...
        /// <summary>
        /// Used to detect if any key is pressed
        /// </summary>
        ...
        {
            // displays the binding in string format to the text box
            _text.text = BindingManager.GetBinding(_binding).ValueDisplay;
        }

        public static void UpdateTextWithBinding(string _binding, string _text)
        {
            // displays the binding in string format to the text box
            _text = BindingManager.GetBinding(_binding).ValueDisplay;
        }
    }
}